...
;(function(window, undefined) {
  ...
  window.Porter = function Porter(resources) {
      ...
      ajax.run = function(callbacks, validators) {
        ...
        if(conf.data) {
          ...
          try { 
            ...
            if(validators && validators['out']) {
              validation = validators['out'](conf.data);
              if(validation !== true) {
        ...
        ajax.xhr.onreadystatechange = function() {
          ...
          switch (ajax.xhr.readyState) {
            ...
            case 4:
              ...
              if(validators && validators['in']) {
                validation = validators['in'](response);
              }
    ...
    function req(url, method, replace, data, callbacks, validateIn, validateOut) {
          ...
          if(Object.prototype.toString.call(resources[resource]) == "[object Array]") {
            ...
            ns[resource] = (function(request) {
              ...
              return function() {
                ...
                args = [url, method].concat(args, validators);
